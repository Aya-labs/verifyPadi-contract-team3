        ...
        <div className='h-screen w-full flex justify-around '>
            ...
            <div className="bg-white w-[50vw] flex-col">
                <div className='float-right flex-row justify-evenly w-20  inline'>
                    <FontAwesomeIcon onClick={handleClick} className='mt-[3rem] p-2 rounded-full bg-[#D5F1FF] hover:translate-y-2 transition ease-in-out duration-300   ' icon={faArrowLeft} />
                ...
                <div className='bg-[#D5F1FF] w-[439px] h-[367.257px] mt-2 items-center flex-col flex ml-32 rounded-3xl'>
                    ...
                    <p onClick={handleClicks} className='font-Prompt pt-10 right-2 mr-20 text-[14.519px] text-[#56577F]'>Connect your wallet</p>
                </div>
            </div>
        </div >
