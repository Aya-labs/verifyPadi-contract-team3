...
const IndividualLogin = () => {
    ...
    return (
        ...
        <div className='h-[124vh] w-full flex justify-around '>
            <div className="bg-gradient-to-tl from-[#01033F] to-[#2EB9FF] w-[50vw] ">
                <img src={logo} alt="logo" className=' cursor-pointer pt-10 pl-10  animate-moveinright ' />
                <img src={logo1} alt="logo" className=' cursor-pointer mt-60 ml-32  animate-moveinopacity ' />
            ...
            <div className="bg-white w-[50vw] h-auto flex-col">
                ...
                <div className='bg-[#D5F1FF] w-[439px] h-[367.257px] mt-2 items-center flex-col flex ml-32 rounded-3xl'>
                    ...
                    <input className=' mt-10 mb-10 font-Prompt border-white  ' type="text" placeholder='Full Name' />

                    <input className=' mb-10 font-Prompt' type="text" placeholder='Email address' />
