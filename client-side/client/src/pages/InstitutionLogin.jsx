...
import logo1 from '../../images/shield.png';
...
const InstitutionLogin = () => {
    ...
    //navigation to the connect wallet page 
    ...
    return (
        ...
        <div className='h-[124vh] w-full flex justify-around '>
            <div className="bg-gradient-to-tl from-[#262666] to-[#BC2EFF] w-[50vw] ">
                <img src={logo} alt="logo" className=' cursor-pointer pt-10 pl-10  animate-moveinright ' />
                <img src={logo1} alt="logo" className=' cursor-pointer mt-40   animate-moveinopacity ' />
