        ...
        <div className='bg-gradient-to-tr from-[#145394] to-[#01033f] w-[20vw] h-[350vh]  flex  items-center flex-col '>
            ...
            <div className='text-white mt-20'>
                <ul className='text-[18px] font-Prompt'>
                    <li onClick={forwardClicks} className='mb-5 flex hover:bg-white hover:text-[#01033f] cursor-pointer rounded-md '><img src={home} className='w-[20px] h-[20px]' alt="home image" /><figcaption className='pl-2'>Home</figcaption> </li>
                    <li className=' mb-5 flex  bg-white text-[#01033f] cursor-pointer hover:rounded-md  '><img src={Account} className='w-[20px] h-[20px]' alt="home image" /><figcaption className='pl-2'>Account</figcaption></li>
